    ...
    groups: [
      {
        items: [
          ...
          { label: "WAR & player impact", href: "/analytics/war" },
          { label: "Lines & with-or-without-you", planned: "Planned: on-ice xGF/xGA per 60 by line and pairing, from the same shift data as WAR." },
